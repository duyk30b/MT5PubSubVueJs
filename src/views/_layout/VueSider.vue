...
<template>
  <a-menu v-model:selectedKeys="selectedKeys" theme="light" mode="inline" :inline-collapsed="false" :openKeys="openKeys"
    ...
    <a-sub-menu v-if="user?.userType === UserType.Root || user?.userType === UserType.Admin" key="User">
      <template #icon>
        <IconTeam />
      </template>
