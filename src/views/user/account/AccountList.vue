...
import BugDevelopment from '@/views/_component/BugDevelopment.vue'
...
<template>
  ...
  <div class="page-main">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr v-for="(user) in userList" :key="user.id">
            ...
            <td class="text-center">
              <a style="color: #eca52b" class="text-xl" @click="modalAccountUpsert?.openModal(user.id)">
                <IconForm />
              </a>
            </td>
          </tr>
    ...
    <div class="p-4 flex flex-wrap justify-end gap-4">
      <VuePagination v-model:page="page" :total="total" :limit="limit"
        @update:page="(p: any) => changePagination({ page: p, limit })" />
      <InputSelect v-model:value="limit" @update:value="(l: any) => changePagination({ page, limit: l })" :options="[
